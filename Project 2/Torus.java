...
public class Torus extends ThreeDimensionalShape {
	...
	public Torus(int numDim, float tempInner, float tempOuter) throws IllegalVariableException {
		super(numDim);
		if(tempInner>tempOuter)
			throw new IllegalVariableException("Inner radius must be smaller than the outer radius.");
		this.innerRadius = tempInner;
		this.outerRadius = tempOuter;
	}
	
	public Torus(float tempInner, float tempOuter) throws IllegalVariableException {
		super();
		if(tempInner>tempOuter)
			throw new IllegalVariableException("Inner radius must be smaller than the outer radius.");
		this.innerRadius = tempInner;
